...
CREATE TABLE #subject_student_quantity(id_subject int, subject_name nvarchar(50), student_quantity int, subject_avg_mark smallint);
...
SELECT subject_name, subject_avg_mark FROM #subject_student_quantity WHERE student_quantity >= 35;
